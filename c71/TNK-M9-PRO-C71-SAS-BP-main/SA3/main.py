...
menuImages = []
path = "C:/Users/arnav/Downloads/c71/TNK-M9-PRO-C71-SAS-BP-main/SA1/filters"
...
while True:
    ...
    try:
        ...
        if (isImageSelected):
            ...
            cameraFeedImg = cvzone.overlayPNG(cameraFeedImg, image, [int(indexFingerTop[0]), int(indexFingerBottom[1])])
